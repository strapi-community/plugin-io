...
const require$$0$9 = require("assert");
const require$$2 = require("events");
const require$$0$b = require("buffer");
const require$$0$a = require("stream");
...
const require$$0__default$3 = /* @__PURE__ */ _interopDefault(require$$0$7);
const require$$0__default$5 = /* @__PURE__ */ _interopDefault(require$$0$9);
const require$$2__default = /* @__PURE__ */ _interopDefault(require$$2);
const require$$0__default$7 = /* @__PURE__ */ _interopDefault(require$$0$b);
const require$$0__default$6 = /* @__PURE__ */ _interopDefault(require$$0$a);
const require$$2__default$1 = /* @__PURE__ */ _interopDefault(require$$2$1);
const require$$0__default$8 = /* @__PURE__ */ _interopDefault(require$$0$c);
...
const parseDate = (value) => {
  ...
  try {
    ...
    if (dates__namespace.isValid(date2)) return dates__namespace.format(date2, "yyyy-MM-dd");
...
(function(module2, exports$1) {
  !function(t, n) {
    module2.exports = n(require$$0__default$1.default, require$$1__default.default);
    ...
    return function(t2) {
      ...
      t2.exports = require$$0__default$1.default;
    }, function(t2, n2) {
...
const generateInstallId = (projectId, installId) => {
  ...
  try {
    ...
    return projectId ? require$$1__default.default.createHash("sha256").update(`${machineId}-${projectId}`).digest("hex") : require$$1__default.default.randomUUID();
  } catch (error2) {
...
function requireWindows() {
  ...
  windows = isexe2;
  isexe2.sync = sync2;
  var fs2 = require$$0__default$3.default;
...
const fs$7 = require$$0__default$3.default;
...
const cp = require$$0__default$1.default;
...
(function(module2) {
  const path2 = require$$0__default$4.default;
...
var _os$1 = require$$0__default$2.default;
var _core = core$2;
...
var _os = require$$0__default$2.default;
...
const stream$1 = require$$0__default$6.default;
...
const childProcess = require$$0__default$1.default;
...
const fs$6 = require$$0__default$3.default;
...
const fs$5 = require$$0__default$3.default;
...
const fs_1 = require$$0__default$3.default;
...
var Stream = require$$0__default$6.default.Stream;
...
if (!fs$1[gracefulQueue]) {
  ...
  if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || "")) {
    process.on("exit", function() {
      ...
      require$$0__default$5.default.equal(fs$1[gracefulQueue].length, 0);
    });
  }
}
