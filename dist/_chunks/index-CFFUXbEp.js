...
const ForwardRef$20 = React.forwardRef(SvgDownload);
const SvgDrag = ({
  fill: fillProp = "currentColor",
  stroke: strokeProp,
  ...props
...
const ForwardRef$14 = React.forwardRef(SvgMessage);
const SvgMicrophone = ({
  fill: fillProp = "currentColor",
  stroke: strokeProp,
  ...props
...
const ForwardRef$u = React.forwardRef(SvgServer);
const SvgShield = ({
  fill: fillProp = "currentColor",
  stroke: strokeProp,
  ...props
...
const ForwardRef$7 = React.forwardRef(SvgUpload);
const SvgUser = ({
  fill: fillProp = "currentColor",
  stroke: strokeProp,
  ...props
...
const ForwardRef$6 = React.forwardRef(SvgUser);
const SvgVolumeMute = ({
  fill: fillProp = "currentColor",
  stroke: strokeProp,
  ...props
...
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx(ForwardRef$u, {});
const index = {
  register(app) {
    app.registerPlugin({
      id: PLUGIN_ID,
      ...
      [
        {
          ...
          Component: () => Promise.resolve().then(() => require("./SettingsPage-CqVIS3HE.js")).then((mod) => ({ default: mod.SettingsPage }))
        },
        {
          intlLabel: {
          ...
          Component: () => Promise.resolve().then(() => require("./MonitoringPage-DFTe8VAr.js")).then((mod) => ({ default: mod.MonitoringPage }))
        }
      ]
    );
    if ("widgets" in app) {
      app.widgets.register({
        ...
        component: async () => {
          const component = await Promise.resolve().then(() => require("./SocketStatsWidget-CAVXxOxe.js"));
...
exports.ForwardRef$6 = ForwardRef$6;
exports.ForwardRef$7 = ForwardRef$7;
