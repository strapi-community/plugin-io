...
const index$2 = require("./index-6JvD14P2.js");
...
`;
const Container = styled__default.default(index$2.Box)`
...
`;
const Header = styled__default.default(index$2.Box)`
...
`;
const Title = styled__default.default(index$2.Typography)`
  color: #fff;
  font-size: 1.5rem;
  font-weight: 700;
  display: flex;
...
`;
const Subtitle = styled__default.default(index$2.Typography)`
...
`;
const StatCard = styled__default.default(index$2.Box)`
...
`;
const StatIcon = styled__default.default(index$2.Box)`
  width: 48px;
  height: 48px;
  border-radius: 10px;
  display: flex;
...
`;
const StatValue = styled__default.default(index$2.Typography)`
  font-size: 2rem;
  font-weight: 700;
...
`;
const StatLabel = styled__default.default(index$2.Typography)`
  font-size: 0.75rem;
...
`;
const Card = styled__default.default(index$2.Box)`
  background: ${({ theme }) => theme.colors.neutral0};
  border-radius: 10px;
  padding: 16px;
  box-shadow: ${({ theme }) => theme.shadows.filterShadow};
...
`;
const CardTitle = styled__default.default(index$2.Typography)`
  font-size: 1rem;
  font-weight: 700;
  color: ${({ theme }) => theme.colors.neutral800};
  margin-bottom: 12px;
...
`;
const ClientItem = styled__default.default(index$2.Box)`
...
`;
const EventItem = styled__default.default(index$2.Box)`
  background: ${({ theme }) => theme.colors.neutral100};
  border-radius: 8px;
  padding: 10px 12px;
  margin-bottom: 8px;
...
`;
const EmptyState = styled__default.default(index$2.Box)`
  text-align: center;
  padding: 24px 16px;
  display: flex;
  flex-direction: column;
...
`;
const ResponsiveBox = styled__default.default(index$2.Box)`
  min-width: 100%;
...
const MonitoringPage = () => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntime.jsx(Container, { children: /* @__PURE__ */ jsxRuntime.jsx(index$2.Box, { padding: 8, style: { textAlign: "center" }, children: /* @__PURE__ */ jsxRuntime.jsx(index$2.Loader, { children: "Loading..." }) }) });
  }
  return /* @__PURE__ */ jsxRuntime.jsxs(Container, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(Header, { children: /* @__PURE__ */ jsxRuntime.jsxs(
      index$2.Flex,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(index$2.Box, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(index$2.Flex, { gap: 2, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        index$2.Flex,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(index$2.Box, { style: { width: "100%", maxWidth: "220px" }, children: /* @__PURE__ */ jsxRuntime.jsxs(index$2.Field.Root, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(index$2.Field.Label, { children: "Event Name" }),
            ...
            /* @__PURE__ */ jsxRuntime.jsx(index$2.Box, { style: { flex: 1 }, children: /* @__PURE__ */ jsxRuntime.jsxs(index$2.Field.Root, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(index$2.Field.Label, { children: "Event Data (JSON)" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                index$2.TextInput,
                {
                  value: testEventData,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ResponsiveGrid, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(ResponsiveBox, { children: /* @__PURE__ */ jsxRuntime.jsxs(Card, { style: { minHeight: "280px" }, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(index$2.Flex, { justifyContent: "space-between", alignItems: "center", marginBottom: 3, children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(index$2.Badge, { active: true, children: [
            stats?.connections?.connected || 0,
            " online"
          ] })
        ] }),
        stats?.connections?.sockets?.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx(index$2.Box, { style: { maxHeight: "220px", overflowY: "auto" }, children: stats.connections.sockets.map((s) => /* @__PURE__ */ jsxRuntime.jsx(ClientItem, { children: /* @__PURE__ */ jsxRuntime.jsxs(
          index$2.Flex,
          {
            direction: { base: "column", tablet: "row" },
            justifyContent: "space-between",
            ...
            gap: 2,
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(index$2.Box, { style: { flex: 1, minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntime.jsx(index$2.Typography, { variant: "omega", fontWeight: "bold", children: s.user ? s.user.username : "Anonymous" }),
                /* @__PURE__ */ jsxRuntime.jsxs(index$2.Flex, { gap: 1, wrap: "wrap", children: [
                  /* @__PURE__ */ jsxRuntime.jsx(index$2.Typography, { variant: "pi", textColor: "neutral600", style: { fontSize: "12px" }, children: s.user?.email || s.handshake.address }),
                  /* @__PURE__ */ jsxRuntime.jsx(index$2.Typography, { variant: "pi", textColor: "neutral400", children: "•" }),
                  /* @__PURE__ */ jsxRuntime.jsx(index$2.Typography, { variant: "pi", textColor: "neutral500", style: { fontSize: "12px" }, children: s.user?.role || "public" })
                ] }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  index$2.Typography,
                  {
              ...
              /* @__PURE__ */ jsxRuntime.jsx(index$2.Badge, { active: s.connected, children: s.connected ? "Online" : "Offline" })
            ]
          }
        ) }, s.id)) }) : /* @__PURE__ */ jsxRuntime.jsxs(EmptyState, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(UsersIcon, {}),
          /* @__PURE__ */ jsxRuntime.jsx(index$2.Typography, { variant: "delta", textColor: "neutral600", children: t("monitoring.noClients", "No clients connected") })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntime.jsx(ResponsiveBox, { children: /* @__PURE__ */ jsxRuntime.jsxs(Card, { style: { minHeight: "280px" }, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(index$2.Flex, { justifyContent: "space-between", alignItems: "center", marginBottom: 2, children: [
          /* @__PURE__ */ jsxRuntime.jsxs(CardTitle, { style: { marginBottom: 0 }, children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(index$2.Badge, { children: filteredEvents.length })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(
          index$2.Flex,
          {
            ...
            marginBottom: 3,
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(index$2.Box, { style: { flex: 1 }, children: /* @__PURE__ */ jsxRuntime.jsx(
                index$2.TextInput,
                {
        ...
        filteredEvents.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx(index$2.Box, { style: { maxHeight: "180px", overflowY: "auto" }, children: filteredEvents.slice().reverse().slice(0, 10).map((e, i) => /* @__PURE__ */ jsxRuntime.jsx(EventItem, { children: /* @__PURE__ */ jsxRuntime.jsx(
          index$2.Flex,
          {
            direction: { base: "column", tablet: "row" },
            justifyContent: "space-between",
            alignItems: { base: "flex-start", tablet: "center" },
            gap: 2,
            children: /* @__PURE__ */ jsxRuntime.jsxs(index$2.Box, { style: { flex: 1, minWidth: 0 }, children: [
              /* @__PURE__ */ jsxRuntime.jsxs(index$2.Flex, { gap: 2, alignItems: "center", wrap: "wrap", marginBottom: 1, children: [
                /* @__PURE__ */ jsxRuntime.jsx(index$2.Badge, { children: e.type }),
                /* @__PURE__ */ jsxRuntime.jsx(index$2.Typography, { variant: "pi", textColor: "neutral500", style: { fontSize: "11px" }, children: new Date(e.timestamp).toLocaleTimeString() })
              ] }),
              /* @__PURE__ */ jsxRuntime.jsxs(
                index$2.Typography,
                {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(BoltIcon, {}),
          /* @__PURE__ */ jsxRuntime.jsx(index$2.Typography, { variant: "delta", textColor: "neutral600", children: searchTerm || eventTypeFilter !== "all" ? t("monitoring.noMatchingEvents", "No matching events") : t("monitoring.noEvents", "No events logged") })
        ] })
      ] }) })
    ] })
  ] });
